...
export default class CheckoutActivity extends Component {
  ...
  next() {
    this.props.navigator.push({
      name: Environment.Routes.Confirmation
    });
  }

  render() {
    logger.debug("Rendering Checkout Activity");
    return (
      <Container>
        <Content>
          <H1>
      ...
      <CustomFooterTab tab={Environment.Routes.Checkout} navigator={this.props.navigator}/>
      </Container>
    );
  }
}
